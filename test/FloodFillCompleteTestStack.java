...
public class FloodFillCompleteTestStack {
    public static void main(String[] args) {
        System.out.println("=== TESTE COMPLETO DO FLOODFILL STACK ===\n");
        ...
        FloodFillStack floodFillStack = new FloodFillStack(image, "assets/output/", 1000);
        ...
        floodFillStack.paint(x, y, new Color(255, 0, 0));
